...
\subsection{竞赛}
\cventry{2013.10.1---2013.11.15}{中国第一届大数据技术创新大赛}{移动用
  户交往圈构建和特定类型用户识别}{排名}{6/23}{}
...
\cventry{2013.11}{summarize36kr}{对36kr的文章智能生成摘要}{个人项
  目}{代码: \url{https://github.com/stephenLee/summarize36ke}}{}
\vspace*{0.2\baselineskip}
...
\section{计算机技能}
\cvline{编程语言}{\small C, C++, Java, Scala(了解)}
