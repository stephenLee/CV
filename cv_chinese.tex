...
{研究方向： 异构网络挖掘}{感兴趣方向：机器学习，社交网络，数据科学(正在学习Cousera公开课data science)}
...
{Link Prediction in Heterogeneous Networks
  Based on Tensor Factorization}{基于张量对异构网络建模,通过对真实的异构网络数据实验说明了使用CP张量分解能够更好的挖掘异构网络的结构，提高了链路预测的准确性}{即将发表}{}{}
